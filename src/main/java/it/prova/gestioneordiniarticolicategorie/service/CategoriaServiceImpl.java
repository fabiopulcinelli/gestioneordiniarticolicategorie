...
public class CategoriaServiceImpl implements CategoriaService {
	...
	public void rimuovi(Long categoriaId) throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			categoriaDAO.delete(categoriaDAO.get(categoriaId));
	...
	@Override
	public void rimuoviArticoloDaCategoria(Long idArticolo, Long idCategoria) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			categoriaDAO.removeArticoli(idArticolo, idCategoria);
	...
	public List<String> trovaTuttiCodiciPerMeseOrdine(Date dataInput) throws Exception {
		...
		try {
			...
			return categoriaDAO.findAllCodiciByOrdineMonth(dataInput);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
